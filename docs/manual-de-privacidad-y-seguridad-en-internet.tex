...
Bookdown template to read online or download PDF or ePub (ebook) format from above options menu.
...
This is an example of reference or bibliography source \citep{example-ref} that will take you to wikipedia source.
